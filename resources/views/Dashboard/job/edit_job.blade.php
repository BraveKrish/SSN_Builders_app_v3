                                        ...
                                        <form action="{{ route('jobs.update', $job->id) }}" method="POST"
                                            ...
                                            <div class="d-flex justify-content-start mb-3">
                                                <button type="submit" class="btn btn-success mr-2 text-white"><i
                                                        class="fas fa-plus"></i> Update Job Listing</button>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" id="description" rows="3" placeholder="Enter job description">{{ $job->description }}</textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="posted_date" class="form-control" id="post_date"
                                                    placeholder="Enter post_date" value="{{ $job->posted_date }}">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="job_category" id="category">
                                                @foreach ($jobCategories as $key => $value)
                                                    <option value="{{ $key }}"
                                                        {{ oldSelect($key, old('job_category', $job->job_category)) }}>
                                                        {{ $value }}
                                                    </option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="job_type" id="type">
                                                @foreach ($jobTypes as $key => $value)
                                                    <option value="{{ $key }}"
                                                        {{ oldSelect($key, old('job_type', $job->job_type)) }}>
                                                        {{ $value }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="level" id="level">
                                                @foreach ($levels as $key => $value)
                                                    <option value="{{ $key }}"
                                                        {{ oldSelect($key, old('level', $job->level)) }}>
                                                        {{ $value }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status" id="status">
                                                @foreach ($status as $key => $value)
                                                    <option value="{{ $key }}"
                                                        {{ oldSelect($key, old('status', $job->status)) }}>
                                                        {{ $value }}</option>
                                                @endforeach
                                            </select>
                                        </div>
