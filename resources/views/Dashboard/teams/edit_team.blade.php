                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('teams.update', $team->id) }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="bio" id="bio" rows="3" placeholder="Enter team bio">{{ $team->bio }}</textarea>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="position" id="position">
                                                @foreach ($positions as $key => $value)
                                                    <option {{ oldSelect($team->position, old('position', $key)) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status" id="status">
                                                {{-- @foreach ($positions as $key => $value) --}}
                                                <option {{ oldSelect($team->status, old('status', 1)) }} value="1">
                                                    Active</option>
                                                <option {{ oldSelect($team->status, old('status', 0)) }} value="0">
                                                    Deactive</option>
                                                {{-- @endforeach --}}
                                            </select>
                    ...
                    <div class="card col-lg-12 col-md-12 col-sm-12 col-xs-12 my-2">
                        <div class="row mx-3 my-3">
                            ...
                            <div class="col-3">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <img src="{{ asset($team->photo_path) }}" alt="team image" height="auto"
                                            width="200px">
                                    </div>
                                </div>
                            </div>
