                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="">Team Update</a></li>
                              ...
                              <div class="card">
                                  ...
                                  <div class="card-body">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="contact" name="contact" value="{{ $team->contact }}" >
                                    </div>
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="position" name="position">
                                                ...
                                                <option value="{{ $pKey }}" {{ $team->position == $pKey ? 'selected' : '' }}>{{ $pValue }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="status" name="is_active">
                                                ...
                                                <option value="0" {{ $team->is_active == 0 ? 'selected' : '' }}
                                                    >Inactive</option>
                                            </select>
                                        </div>
                                      </div>
